    ...
    if (git_repo_url.equals('null') || git_reference.equals('null')) {
        ...
        withCredentials([
            ...
            sh """
                ...
                ./gradlew clean && ./gradlew ':plugins:telemetry-otel:internalClusterTest' --tests 'org.opensearch.telemetry.metrics.TelemetryMetricsEnabledSanityIT.testGaugeWithValueAndTagSupplier' -Dtests.coverage=true ${bwc_checkout_align_param} --no-daemon --no-scan || GRADLE_CHECK_STATUS=1
