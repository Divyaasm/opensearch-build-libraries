    ...
    if (git_repo_url.equals('null') || git_reference.equals('null')) {
        ...
        withCredentials([
            ...
            sh """
                ...
                ./gradlew clean && ./gradlew check jacocoTestReport --continue -Dtests.coverage.report.html=true ${bwc_checkout_align_param} --no-daemon --no-scan || GRADLE_CHECK_STATUS=1
