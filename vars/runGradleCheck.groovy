    ...
    if (git_repo_url.equals('null') || git_reference.equals('null')) {
        ...
        withCredentials([
            ...
            sh """
                ...
                ./gradlew clean && ./gradlew check -x test -x internalClusterTest -x :plugins:repository-s3:s3ThirdPartyTest -Dtests.coverage=true ${bwc_checkout_align_param} --no-daemon --no-scan || GRADLE_CHECK_STATUS=1
