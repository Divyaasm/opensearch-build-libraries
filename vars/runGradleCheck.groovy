    ...
    if (git_repo_url.equals('null') || git_reference.equals('null')) {
        ...
        withCredentials([
            ...
            sh """
                ...
                ./gradlew clean && ./gradlew ':rest-api-spec:yamlRestTest' --tests 'org.opensearch.test.rest.ClientYamlTestSuiteIT' -Dtests.coverage=true ${bwc_checkout_align_param} --no-daemon --no-scan || GRADLE_CHECK_STATUS=1
